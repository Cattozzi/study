...
public class Hospital {
        ...
        public OptionalDouble calcularMediaIdadeCriticos() {
                return pacientes.stream()
                        ...
                        .mapToInt(Paciente::idade) // Evita boxing/unboxing desnecessário
                        .average();
        }
        ...
        public long contarSegurados() {
                return pacientes.stream()
                        .filter(Paciente::possuiPlano) // Method Reference elegante
                        .count();
        }
}