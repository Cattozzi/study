...
public class GlobalExceptionHandler {
    ...
    tratarRecursoNaoEncontradoException(RecursoNaoEncontradoException ex) {
        ...
        problemDetail.setType(URI.create("https://api.universidade.com/erros/recurso-naoencontrado"));
    ...
    public ProblemDetail
    tratarMethodArgumentNotValidException(MethodArgumentNotValidException ex) {
        ProblemDetail problemDetail = ProblemDetail.forStatusAndDetail(
        ...
        problemDetail.setType(URI.create("https://api.universidade.com/erros/dadosinvalidos"));
    ...
    public ProblemDetail tratarExcecoesNaoMapeadas(Exception ex) {
        ...
        problemDetail.setType(URI.create("https://api.universidade.com/erros/errointerno"));
        problemDetail.setProperty("timestamp", Instant.now());
        return problemDetail;
    }
}